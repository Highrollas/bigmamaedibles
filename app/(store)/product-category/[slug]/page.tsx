            ...
            <div>
                  ...
                  {/* {(slug === "shake" || slug == "trim") &&
                        <div className='flex justify-center gap-3 my-5'>
                              <Link href="/product-category/shake" className={(slug === "shake" ? "brand-panel text-white" : "bg-white text-black") + " ic-img py-[15px] px-[20px] rounded-[0.375rem]"}>Shake</Link>
                              <Link href="/product-category/trim" className={(slug === "trim" ? "brand-panel text-white" : "bg-white text-black") + " ic-img py-[15px] px-[20px] rounded-[0.375rem]"}>Trim</Link>
                        </div>
                  } */}
                  ...
                  {totalPages > 1 && (
                        <div className='w-full flex justify-center'>
                              <div className="brand-panel-secondary flex justify-center mb-12 border-[3px] gap-[2.5px] brand-border-secondary rounded-[6px] w-fit">
